...
- Graphics Engineer & 3D Solution
  - 다양한 레벨 수준에서 3D 솔루션을 개발한 경험 OpenGL (low) / VTK (middle) / Unity (high)
  - 3D Graphics 포지션에서의 경험을 바탕으로 3D 공간과 2D 평면 개념을 연관지어 문제점 해결.
...
2020.01 ~ 2020.06 | 한국ㅇㅇㅇㅇ연구원 | 연구원
> - 자율주행 시뮬레이터 개발
>   - 가상 센서 구현, 대용량 데이터 전송 시스템
>   - 테크니컬 리딩, 고성능 모듈 개발, 유니티 호환 네트워크 시스템 구현
>   - 유니티 개발환경 기술 검토, 기술 세미나, 개발 이슈 지원

<br/>

2019.05 ~ 2019.12 | ㅇㅇㅇㅇㅇ | 국비교육 강사
> - 혁신성장 청년인재 집중양성 과정 풀타임 강의 (MSIT)
>   - C, C++, C#, WinForm, Unity, Unreal, AR, VR
>   - 컴퓨터공학 기본 이론, 자료구조, 알고리즘
>   - 실무형 프로젝트
...
> - KAIST 산학협력 연구개발(360 VR, 과기부 국책과제), C 기반 모듈 개발, 성능 최적화, 기술 지원
> - Unity 기반의 VR 기술 연구 및 저작도구 개발

<br/>

2013.01 ~ 2013.02 | ㅇㅇㅇㅇㅇ 기업부설연구소 | 인턴
> - 리눅스 기반 개발환경, 연구소 내 개발 문화 경험
> - 인턴쉽 프로그램: 연구소장님 참관, 사내 Java 개발자 대상으로 C++ 강의 후 피드백, 스터디 자료 준비
...
- 웹 3D Viewer를 위한 웹 서비스 사이트 개발 (2022.09 ~ 2023.05)
  > - 역할: 테크니컬 리딩, 웹 시스템 구조 설계 및 구축, 프론트 개발, 백엔드 구조 설계
  > - 기술: JavaScript, Vue.js, Node.js, AWS Cloud 

<br/>

- 치아 데이터를 분석 및 가공해서 업로드하는 솔루션 연구 및 개발 (2022.05 ~ 2023.01)
  > - 역할: 테크니컬 리딩, 성능 최적화를 위한 기법 연구, HTTP 통신 모듈
  > - 기술: C++, VTK, QT, CURL, InfoZip, Eigen

<br/>

- 스캔 데이터를 활용한 얼굴분석 & 성형 통합 솔루션 개발 (2021.01 ~ 2022.03)
  > - 역할: 3D 프로그램 구조 설계 및 기반 시스템 개발, 테크니컬 리딩, 모듈 개발, 성능 최적화
  > - 기술: C++, VTK, QT, OpenCV, Dlib, LibIGL, OpenMesh

<br/>

- 가상 성형 프로그램 프로토타입 개발 (2020.10 ~ 2020.12)
  > - 역할: 3D 프로그램 개발, Morphing알고리즘 연구 개발, 시스템 설계 및 디자인, 성능 최적화
  > - 기술: C++, VTK, QT, OpenCV

<br/>

- 3D 스캔 솔루션 개발 (2020.07 ~ 2020.09)
  > - 역할: 3D Landmark Detecting Detector 알고리즘, 모듈 개발
  > - 기술: C++, OpenGL, VTK, OpenCV, QT, MFC

<br/>

- 자율주행 시뮬레이터 개발 (2020.01 ~ 2020.06)
  > - 역할: 시뮬레이터 개발, 테크니컬 리딩, 성능 최적화, 네트워킹, C모듈 개발
  > - 기술: C#, Unity, Unity Shader, C++

<br/>

- 360 Image 이미지에서 인식된 Masking 처리하는 프로그램의 개발 (2019.01 ~ 2019.03) <br/>
   (상용 프로그램에 사용할 대량의 이미지 편집을 딥러닝 기술로 자동화하는 프로그램)
  > - 역할: 단독 개발, PyQT 프로그램 개발 환경 셋팅, 구조 가이드
  > - 기술: C++, Python, PyQT, OpenCV, Tensorflow, Pillow, Numpy | PyCharm, Spyder, Anaconda
...
- 이미지 정합 프로그램 수행속도 개선 (2018.05)
  > - 역할: 개발된 모듈의 수행속도 개선, 최적화 방법 연구
  > - 기술: C++, OpenCV, CUDA

<br/>

- 문화재 VR 체험 컨텐츠 프로토타입 제작 (2018.01 ~ 2018.03)
<br/> 가공하지 않은 스캔 데이터 원본에도 적용할 수 있는 쉐이더 개발 (2018.01)
  > - 역할: 주 개발자. 기획자와 소통하여 개발 방향 정리. 디자이너와의 협업
...
- 모던 그래픽스 시뮬레이터의 개발 (2017.03 ~ 2017.06)
<br/>    (Lighting, Polygon Control, Shading, Tessellation)
  > - 역할: 프로젝트 리딩, 환경설정, 기획 및 설계, Shader 로직, 로직설계, 소스 연동/통합
  > - 기술: C++, Modern OpenGL (v.4.5), GLSL, GLFW, GLEW, GLM

<br/>

- Motion Controller를 사용한 VR 물리체험 스튜디오 (2017.03 ~ 2017.04)
  > - 역할: 시스템 UI, 배경디자인, 물리 실험 도구 제작
  > - 기술: C#, Unity
  > - 장비: Andriod VR, LeapMotion, RealSence

<br/>

- 핸드/핑거 모션감지 드로잉 프로젝트 (2017.02)
  > - 역할: 사람인식, 손 동작감지, 제스쳐 식별 로직, 코드정리 및 통합
  > - 기술: C++, MFC, OpenCV
...
#### 주요 기술: C++ / VTK / QT / OpenCV

    > ...

<br/>

### 얼굴 특징점 추출 알고리즘 개발, 가상성형 솔루션 프로토타입 (2020.07 ~ 2020.12)
#### 주요 기술: C++ / VTK / QT / OpenCV
...
1. 유니티에서 대용량 Raw Sensor 데이터를 전송하기 위한 네트워킹 기법 연구
    ...
    > - Modern C++ - C# Unity 호환 동적 라이브러리 개발
    > 
    > <br/>
    > 
    > 성과
    > - 빠른 속도로 대용량의 센서 데이터 전송이 가능 (1 Lidar / 6 Camera)
    > - 유니티에 호환 가능한 라이브러리 연결 방식 구현, 유연한 코드 작성 가능

2. 가상 센서 모듈의 연구 개발 (Lidar Sensor, Camera Sensor)
    > - Velodyne Lidar 실제 하드웨어 스펙과 동일하게 동작하는 가상 센서 모듈 구현
    > - 다량의 연산으로 인한 시스템 부하를 해결하기 위한 다양한 방법 연구
    > - 유니티 시스템의 한계를 극복하기 위한 기술 연구개발
    >   - Custom & Dynamic Mesh Generation
    >   - GPU Instancing
    >   - ECS, Job System, Burst Compiler
    >   - Computing Shader, GPGPU
    >   - C Module for Unity Plugin
    >   
    > <br/>
    > 
    > 성과
